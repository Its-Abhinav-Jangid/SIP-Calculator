...
if (window.screen.width < 600) {
  const chartCanvas = document.getElementById("chart-mobile");
...
function calculate() {
  ...
  const roi = parseInt(document.getElementById("roi-display").value);
  const duration = parseInt(document.getElementById("duration-display").value);
